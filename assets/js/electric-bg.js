...
var settings = {
  ...
  lineLength: 100,
  speed: 1,
  lifeTime: canvas.parentNode.parentElement.offsetWidth * 1,
  maxParticles: 8,
  radius:4,
  avoidVisited: true,
...
function onResize() {
  width = canvas.width = canvas.parentNode.parentElement.offsetWidth;
  height = canvas.height = canvas.parentNode.parentElement.offsetHeight;
}
...
function updateAndDraw() {
  ...
  ctx.fillStyle = 'rgba(196,77,88, 0.035)';
